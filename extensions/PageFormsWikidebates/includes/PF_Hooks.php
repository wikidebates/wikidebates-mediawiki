...
class PFHooks {
	...
	public static function initialize() {
		$GLOBALS['wgPageFormsScriptPath'] = $GLOBALS['wgExtensionAssetsPath'] . '/PageFormsWikidebates';
	...
	public static function showFormPreview( EditPage $editpage, WebRequest $request ) {
		...
		$editpage->previewTextAfterContent .= Html::element( 'h2', null, wfMessage( 'pf-preview-header' )->text() ) . "\n" .
			Html::rawElement( 'div', [ 'id' => 'pfForm', 'class' => 'previewnote pf-form-previewnote' ], $previewNote ) . "\n<hr />\n";
		...
		PFUtils::addFormRLModules( null, [ 'formHtml' => $form_text ] );
		$editpage->previewTextAfterContent .=
			Html::rawElement( 'div', [ 'class' => 'pf-form-preview-wrapper' ], $form_text );
	}
	...
	public static function handleForceReload( $out, Skin $skin ) {
		...
		$text = "\t" . Html::rawElement( 'p', [ 'class' => 'pf-force-reload-loading' ], $loadingImage );
