...
( function( $, mw ) {
	...
	$.fn.displayPFFormInput = function() {
		...
		if ( this.attr('data-max-suggestions') !== undefined ) {
			autocompleteWidgetConfig['maxSuggestions'] = this.attr('data-max-suggestions');
		}
		if ( this.attr('data-min-input-length') !== undefined ) {
			autocompleteWidgetConfig['minLookupLength'] = this.attr('data-min-input-length');
		}
