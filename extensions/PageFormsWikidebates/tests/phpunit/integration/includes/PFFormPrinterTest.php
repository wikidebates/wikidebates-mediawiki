...
class PFFormPrinterTest extends MediaWikiIntegrationTestCase {
	...
	*/
	...
	public function testTableHTML() {
		...
		// Stub formFieldHTML so that we can easily assert on its output in the layout
		...
		$this->assertStringContainsString( 'class="pf-formlayout"', $result, 'asserts that tableHTML() wraps rows in a div layout' );

		// Holds-template field includes a hidden input with class
